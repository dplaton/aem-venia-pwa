 ...
 * under the License.
 ******************************************************************************/
package org.apache.sling.scripting.sightly.apps.venia.components.page;
...
out.write("\n    ");
{
    ...
    {
        String var_templateoptions1_field$_categories = "venia.base";
        {
...
out.write("\n\n<meta name=\"theme-color\" content=\"#000000\"/>\n<link rel=\"icon\" href=\"/etc.clientlibs/venia/clientlibs/clientlib-react/resources/favicon.ico\"/>\n<link rel=\"apple-touch-icon\" href=\"/etc.clientlibs/venia/clientlibs/clientlib-react/resources/logo192.png\"/>\n<link rel=\"manifest\" href=\"/etc.clientlibs/venia/clientlibs/clientlib-react/resources/manifest.json\"/>\n\n<!-- AEM page model -->\n");
...
{
    Object var_attrvalue4 = renderContext.getObjectModel().resolveProperty(_global_page, "hierarchyRootJsonExportUrl");
    {
...
out.write("/>\n\n");
{
    Object var_testvariable8 = ((renderContext.getObjectModel().toBoolean(renderContext.getObjectModel().resolveProperty(_dynamic_wcmmode, "edit")) ? renderContext.getObjectModel().resolveProperty(_dynamic_wcmmode, "edit") : renderContext.getObjectModel().resolveProperty(_dynamic_wcmmode, "preview")));
...
out.write("\n");
{
    Object var_testvariable9 = renderContext.getObjectModel().resolveProperty(_dynamic_wcmmode, "edit");
...
out.write("\n");
{
    Object var_testvariable10 = renderContext.getObjectModel().resolveProperty(_dynamic_wcmmode, "preview");
